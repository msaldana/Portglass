...
<head>
	...
	<meta name="description" content="Registration Form for New Portglass User">
...
<div class="container">
	...
	<div class="contact-page main grid-wrap">
		...
		<section class="grid col-three-quarters mq2-col-two-thirds mq3-col-full">
			...
			<form id="register_form" class="register_form" action="./register" method="post" name="register_form">	
				<ul>
					<li>
					...
					<li>
						...
						<input type="text" name="last_name" id="last_name" required class="required" >
					</li>
					<li>
						<label for="phone">Your Phone Number:</label>
						<input type="text" name="phone" id="phone" required class="required number" >
					</li>
					
					<li >
						<label for="email">Email:</label>
						<input type="email" name="email" id="email"  placeholder="user@email.com" required email >
					...
					<li>
						<button type="submit" id="submit" name="submit" class="button fright">Create!</button>
					</li>	
				</ul>			
			</form>
		</section>	
