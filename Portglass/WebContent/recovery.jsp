...
<head>
	...
	<meta name="description" content="Account Recovery Form for Portglass User">
	<meta name="author" content="Manuel R Saldana">
	
	<title>Recover your Portglass Account</title>
...
<div class="container">
	...
	<header id="navtop">
		...
		<nav class="fright">
			...
			<ul>
				<li><a href="recovery.jsp" class="navactive">Account Recovery</a></li>
			</ul>
			<ul>
	...
	<div class="contact-page main grid-wrap">
		...
		<section class="grid col-three-quarters mq2-col-two-thirds mq3-col-full">
			<h2>Account Recovery Form</h2>
			<p class="warning">An email will be sent with further instructions.</p>
			
			<form id="recover_form" class="recover_form" action="./recovery" method="post" name="recover_form">	
				<ul>
